...
//  }
  ...
  function CreateUser(){
    ...
    const URL= "https://precise-communications-api.herokuapp.com/api/insert/"+USERNAME+"/"+PASSWORD+"/"+senderName+"/"+MarketingID+"/"+SHOP_NAME+"/"+JSON.stringify(SHOP_URL)+"/"+STATUS
  ...
  function CreateTable(shopname){
    ...
    const URL= "https://precise-communications-api.herokuapp.com/api/create/"+shopname;
    fetch(URL, requestOptions)
      .then(response => response.text())
  ...
  function onSubmitHandler(e){
   ...
   fetch("https://precise-communications-api.herokuapp.com/api/credits/"+username+"/"+password)
            .then(response=>response.json())
            .then(json=>{
                        if(json.status==="OK"){
